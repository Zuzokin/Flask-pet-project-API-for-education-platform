...
API для обучающей платформы, которая выполняет следующие функции:
...
# Реализация
- Запросы и ответы реализованы при помощи Flask
- Объекты хранятся в runtime
- id генерируется при помощи UUID
- Валидация существования почты и номера телефона производится через регулярные выражения
- График генерируется при помощи matplotlib
- Код отформатирован при помощи black
...
Response example:
```html
<img src="/static/user_leaderboard.png">
```
<p align="left">
  <img src="images/user_leaderboard.png"/>
</p>
